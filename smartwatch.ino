...
char auth[] = "MzkSUeEKe4x3e7bPkjJJFRVeMQJEwY08"; //Enter your Authentication Token
...
const char* ssid = "krishn";   // insert your own ssid
const char* password = "shreeswamisamarth"; // and password
String date;
String t; 
String tempC;
...
const String url = "http://api.openweathermap.org/geo/1.0/direct?q={Mumbai},{27},{91}&limit={limit}&appid={cbeace2825bf5a19df59a4f7abcf1717}"; //put the link to Yahoo Weather API here
const int port = 80;
...
void setup ()
{
  ...
  Serial.println("");
  display.drawString(0, 24, "Hi Computer Department PHCET!");
  display.display();
  delay(1000);
}
